...
impl State {
    ...
    async fn new(window: &Window) -> Self {
        ...
        // Import image and create texture
        let diffuse_bytes = include_bytes!("happy-tree.png"); // CHANGED!
        let diffuse_texture =
            texture::Texture::from_bytes(&device, &queue, diffuse_bytes, "happy-tree.png").unwrap(); // CHANGED!

        // Texture bind group layout and bind group - specify what can be accessed by what shader stages
        ...
        // Define the camera and camera uniform buffer
        let camera = Camera {
        ...
        let camera_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            ...
            contents: bytemuck::cast_slice(&[camera_uniform]), // This works because the crepr and plain old data layout of the struct.
            usage: wgpu::BufferUsages::UNIFORM | wgpu::BufferUsages::COPY_DST,
        });

        // Camera bind group layout and bind group
